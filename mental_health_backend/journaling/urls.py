...
urlpatterns = [
    path('journaling/', JournalingListCreateView.as_view(), name='journaling-list-create'),
    path('journaling/<int:pk>/', JournalingDetailView.as_view(), name='journaling-detail'),
